...
//        case preacher = "preacher_id"
    ...
    init(id: Int, title: String, description: String? = nil, date: Date = .now, preacher: PreacherDTO, videoUrl: String, serie: PreachCollection? = nil, thumbId: String? = nil, collection: PreachCollection? = nil, discipleship: PreachCollection? = nil) {
        self.id = id
        self.title = title
